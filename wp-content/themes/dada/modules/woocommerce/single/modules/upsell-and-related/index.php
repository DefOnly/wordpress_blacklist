...
if( !class_exists( 'Dada_Shop_Single_Module_Upsell_Related' ) ) {

    class Dada_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'dada_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('dada_shop_single_module_upsell_related') ) {
	function dada_shop_single_module_upsell_related() {
		return Dada_Shop_Single_Module_Upsell_Related::instance();
	}
}

dada_shop_single_module_upsell_related();