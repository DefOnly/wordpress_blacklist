...
if( !class_exists( 'Dada_Woo_Others' ) ) {

    class Dada_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'dada_woo_others_settings', $this->settings );
...
if( !function_exists('dada_woo_others') ) {
	function dada_woo_others() {
		return Dada_Woo_Others::instance();
	}
}
