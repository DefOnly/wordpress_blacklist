...
if( !class_exists( 'Dada_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Dada_Woo_Listing_Option_Thumb_Element_Group extends Dada_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'dada_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('dada_woo_listing_option_thumb_element_group') ) {
	function dada_woo_listing_option_thumb_element_group() {
		return Dada_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

dada_woo_listing_option_thumb_element_group();