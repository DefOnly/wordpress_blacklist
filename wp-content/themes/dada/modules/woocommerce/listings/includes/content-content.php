...
if( ! function_exists( 'dada_shop_woo_loop_product_content' ) ) {

	function dada_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				dada_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('dada_woo_loop_product_content_content', 'content');
					remove_all_actions('dada_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'dada_shop_woo_loop_product_content', 10 );
