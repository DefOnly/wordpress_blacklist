...
if( !class_exists( 'Dada_Woo_Listing_Type_Default' ) ) {

    class Dada_Woo_Listing_Type_Default {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Default', 'dada');
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/listings/types/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/listings/types/';
                } else {
        ...
        */
            function render_backend() {
                ...
                /* Custom Product Templates - Options */
                    add_filter( 'dada_woo_default_product_templates', array( $this, 'woo_default_product_templates'), 10, 1 );
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    'id'              => 'dada-woo-product-style-template-'.$this->type_slug,
                    'type'            => 'group',
                    'dada_default_type' => true,
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'dada' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'dada'),
                    'accordion_title' => esc_html__('Add New Template', 'dada'),
                    'fields'          => dada_woo_listing_fw_template_settings()->woo_get_options_params( $type_options, 'default' ),
        ...
        */
            function render_frontend() {
                ...
                if( $non_archive_listing ) {
                    ...
                    /* Types CSS */
                        add_filter( 'dada_woo_non_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );

                } else {

                    /* Types CSS */
                        add_filter( 'dada_woo_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'dada-woo-non-archive', '', array (), DADA_THEME_VERSION, 'all' );
                        wp_enqueue_style( 'dada-woo-non-archive' );
                        ...
                        $css = apply_filters( 'dada_woo_non_archive_css', $css );

                        if( !empty($css) ) {
                            wp_add_inline_style( 'dada-woo-non-archive', $css );
                        }

                    // JS

                        wp_register_script( 'dada-woo-non-archive', '', array ('jquery'), false, true );
                        wp_enqueue_script( 'dada-woo-non-archive' );
                        ...
                        $js = apply_filters( 'dada_woo_non_archive_js', $js );

                        if( !empty($js) ) {
                            wp_add_inline_script( 'dada-woo-non-archive', $js );
                        }
...
if( !function_exists('dada_woo_listing_type_default') ) {
	function dada_woo_listing_type_default() {
		return Dada_Woo_Listing_Type_Default::instance();
	}
}

dada_woo_listing_type_default();