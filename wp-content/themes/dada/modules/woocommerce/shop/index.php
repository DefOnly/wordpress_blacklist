...
if( !class_exists( 'Dada_Woo_Listing_Shop' ) ) {

    class Dada_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'dada_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('dada_woo_listing_shop') ) {
	function dada_woo_listing_shop() {
		return Dada_Woo_Listing_Shop::instance();
	}
}

dada_woo_listing_shop();