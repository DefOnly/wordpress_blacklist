...
if( !class_exists( 'Dada_Woo_Listing_Tag' ) ) {

    class Dada_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'dada_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('dada_woo_listing_tag') ) {
	function dada_woo_listing_tag() {
		return Dada_Woo_Listing_Tag::instance();
	}
}

dada_woo_listing_tag();