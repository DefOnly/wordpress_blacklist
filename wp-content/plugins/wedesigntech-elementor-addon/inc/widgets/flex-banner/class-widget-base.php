        ...
        'label' => esc_html__( 'Settings', 'wdt-elementor-addon'),
            ...
            $elementor_object->add_responsive_control(
                ...
                array(
                    ...
                    'selectors' => array(
                        '{{WRAPPER}} .wdt-flex-banner-options:not(.vertical-slider) .wdt-flex-banner-option' => 'height: {{SIZE}}{{UNIT}};',
                    ),
                    'description' => esc_html__( 'Not Working in the Vertical slider', 'wdt-elementor-addon' )
                )
            );
                        ...
                        if($vertical_slider_settings == "yes") {
                            ...
                            $output .= '<div class="wdt-flex-banner-detail-group">';
                                ...
                                if( !empty( $item['button_link']['url'] ) && $item['button'] !== '' ){
                                    ...
                                    $link_end = '</a>';
                                    $output .= '<div class="wdt-flex-banner-button video-triggr">' . $link_start . $item['button'] . $link_end . '</div>' ;
                                }
                            $output .= '</div>';
                        } else {
