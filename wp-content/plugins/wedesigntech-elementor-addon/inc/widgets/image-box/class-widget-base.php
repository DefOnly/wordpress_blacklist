		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'modern-template' => esc_html__( 'Modern Template', 'wdt-elementor-addon' ),
					'instagram-style' => esc_html__( 'Instagram Style', 'wdt-elementor-addon' ),
					'image-with-carve' => esc_html__( 'Image With Carve', 'wdt-elementor-addon' ),
					'item-bg-with-carve' => esc_html__( 'Separator BG With Carve', 'wdt-elementor-addon' ),
					'img-ico-content-aside' => esc_html__( 'Image Ico-Content Aside', 'wdt-elementor-addon' ),
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
                ...
                'width' => array (
					...
					'selector' => array (
						'{{WRAPPER}} .wdt-rc-template-item-bg-with-carve .wdt-content-item .wdt-content-separator.separator-1, {{WRAPPER}} .wdt-content-item .wdt-content-separator.separator-1 span' => 'width: {{SIZE}}{{UNIT}};'
					)
				),
				'height' => array (
					'field_type' => 'height',
					...
					'selector' => array (
						'{{WRAPPER}} .wdt-rc-template-item-bg-with-carve .wdt-content-item .wdt-content-separator.separator-1, {{WRAPPER}} .wdt-content-item .wdt-content-separator.separator-1 span' => 'height: {{SIZE}}{{UNIT}};'
					)
				),
				'tabs' => array (
					'field_type' => 'tabs',
					'tab_items' => array (
						'normal' => array (
							...
							'styles' => array (
                                'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} div[class$="-carve"] .wdt-content-item .wdt-content-separator.separator-1, {{WRAPPER}} .wdt-content-item .wdt-content-separator.separator-1 span',
									'condition' => array ()
								)
							)
						),
						'hover' => array (
							...
							'styles' => array (
                                'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} div[class$="-carve"] .wdt-content-item:hover .wdt-content-separator.separator-1, {{WRAPPER}} .wdt-content-item:hover .wdt-content-separator.separator-1 span',
									'condition' => array ()
								)
							)
						)
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= $this->cc_layout->get_wrapper_start();
				...
				} else if($settings['template'] == 'modern-template') {
				...
				} else if($settings['template'] == 'instagram-style') {
				...
				} else if($settings['template'] == 'image-with-carve') {
				...
				} else if($settings['template'] == 'item-bg-with-carve') {
				...
				} else if($settings['template'] == 'img-ico-content-aside') {
