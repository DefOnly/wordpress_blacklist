	...
	function __construct() {
		...
		// Options
			...
			$options['default'] = array(
				...
				'sub_heading'  => esc_html__( 'Heading', 'wdt-elementor-addon'),
		...
		// Module defaults
			$option_defaults = array(
				array(
					...
					'item_sub_heading' => esc_html__( 'Leo porta', 'wdt-elementor-addon' ),
				...
				array(
					...
					'item_sub_heading' => esc_html__( 'Amet turpis', 'wdt-elementor-addon' ),
					'item_description' => esc_html__( 'Donec sit amet turpis tincidunt eros, nam porttitor massa leo porta maecenas reque.', 'wdt-elementor-addon' ),
					'item_link'    => array (
						'url' => '#',
						'is_external' => true,
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'aside-image' => esc_html__( 'Aside Image', 'wdt-elementor-addon' ),
			...
			'styles' => array (
				...
				'width' => array (
					...
					'selector' => array (
						...
						{{WRAPPER}} .wdt-content-item-holder.wdt-rc-template-aside-image .wdt-content-item .wdt-content-media-group .wdt-content-elements-group.wdt-media-group .wdt-content-image-wrapper, {{WRAPPER}} .wdt-content-item-holder.wdt-rc-template-aside-image .wdt-content-item .wdt-content-media-group .wdt-content-elements-group.wdt-media-group .wdt-content-image-wrapper .wdt-content-image, {{WRAPPER}} .wdt-content-item-holder.wdt-rc-template-aside-image .wdt-content-item .wdt-content-media-group .wdt-content-elements-group.wdt-media-group .wdt-content-image-wrapper .wdt-content-image > a, {{WRAPPER}} .wdt-content-item-holder.wdt-rc-template-aside-image .wdt-content-item .wdt-content-media-group .wdt-content-elements-group.wdt-media-group .wdt-content-image-wrapper .wdt-content-image > span,
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= $this->cc_layout->get_wrapper_start();
				if($settings['template'] == 'custom-template') {
				...
				} else if($settings['template'] == 'aside-image') {
					...
					$group1_element_group_content_position_elements = array(
						'image' => esc_html__( 'Image', 'wdt-elementor-addon'),
						'description'     => esc_html__( 'Description', 'wdt-elementor-addon'),
						'separator_2'     => esc_html__( 'Separator 1', 'wdt-elementor-addon')
					);
					$group2_content_position_elements = array(
						'title_sub_title' => esc_html__( 'Name & Role', 'wdt-elementor-addon'),
						'rating' 		  => esc_html__( 'Rating', 'wdt-elementor-addon')
