...
class WeDesignTech_Widget_Base_Interactive_Showcase {
		...
		// Module defaults
			$option_defaults = array(
				array(
					...
					'item_sub_title' => esc_html__( 'Vestibulum et', 'wdt-elementor-addon' ),
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= '<div class="wdt-interactive-showcase-container wdt-image-box-interactive-style" data-click="'. esc_js($settings['hover_and_click']) .'">';
									...
									$output .= '<div class="wdt-interactive-showcase-content-group">';
										...
										$output .= '<div class="wdt-interactive-showcase-content-group">';
											...
											if( !empty($item['item_title']) ) {
												$output .= '<div class="wdt-interactive-title"><h4 class="wdt-content-title">'.esc_html($item['item_title']).'</h4></div>';
											}
							...
							$output .= '<div class="wdt-interactive-showcase-media-group">';
								...
								$output .= '<div class="wdt-interactive-showcase-content">';								
									if( !empty($item['item_description']) ) {
										$output .= '<div class="wdt-content-description">'. $item['item_description'].'</div>';
									}
