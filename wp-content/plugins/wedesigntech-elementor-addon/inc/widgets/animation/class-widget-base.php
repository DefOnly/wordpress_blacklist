	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->add_control( 'item_speed', array(
			...
			'selectors' => array (
				'{{WRAPPER}} .wdt-animation-wrapper div[class*="-marqee"].left-to-right, 
				 ...
				 {{WRAPPER}} .wdt-animation-wrapper div[class*="-marqee"].bottom-to-top ~ div.wdt-animation-cloned-marqee' => 'animation-duration: {{SIZE}}s;',
			),
		) );
        ...
        $elementor_object->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} .wdt-animation-text, {{WRAPPER}} .wdt-animation-wrapper > div:has(> .wdt-animation-item.text-item)',
            )
        );
