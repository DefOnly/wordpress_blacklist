		...
		if($type == 'type1') {
			...
			$output .= '<div class="wdt-listings-item-top-section">';
				...
				$output .= '<div class="wdt-listings-item-top-section-content">';
					...
					$view_details_btn = '<span class="detail-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve"><path d="M99,6.3C99,3.4,96.6,1,93.7,1L46.8,1c-2.8,0-5.3,2-5.5,4.8c-0.3,3.1,2.2,5.7,5.2,5.7h41.9c0,0,0.1,0,0.1,0.1l0,41.6 c0,2.8,2,5.3,4.8,5.5c3.1,0.3,5.7-2.2,5.7-5.2V6.3z M12.1,95.4L97.4,10c0,0,0-0.1,0-0.1l-7.3-7.3c0,0-0.1,0-0.1,0L4.8,87.8 c-2.1,2.1-2.1,5.5,0,7.6l0,0C6.8,97.4,10,97.4,12.1,95.4z"/></svg></span>';
					if( $enable_view_details_btn == 'yes' ) {
						$view_details_btn = $view_details_btn;
						$view_icon_btn = 'wdt-icon-button';
					} else {
						$view_details_btn = '';
						$view_icon_btn = '';
					}
					$output .= '<div class="wdt-listings-group-button-hover-icon">';
						$output .= '<a class="custom-button-style wdt-listing-view-details '.$view_icon_btn.'" href="'.esc_url( get_permalink($listing_id) ).'">'.$view_details_btn.'<span>'.esc_html__('View Details','wdt-portfolio').'</span></a>';
