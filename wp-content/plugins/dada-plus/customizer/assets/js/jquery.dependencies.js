;(function ( $, window, document, undefined ) {
    'use strict';
    $.DADAPLUSWPCUSTOMIZER = $.DADAPLUSWPCUSTOMIZER || {};

	$.DADAPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.DADAPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.DADAPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').DADAPLUSWPCUSTOMIZER_DEPENDENCY();
	});
