...
class Dada_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dada-plus-color-control', DADA_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'dada-plus-customizer-color-picker' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-color-control',  DADA_PLUS_DIR_URL.'customizer/controls/color/color.css', null, DADA_PLUS_VERSION );
	}
