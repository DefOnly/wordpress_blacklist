...
class Dada_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dada-plus-spacing-control', DADA_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-spacing-control',  DADA_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, DADA_PLUS_VERSION );
	}
