...
class Dada_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'dada-plus-description-control',  DADA_PLUS_DIR_URL.'customizer/controls/description/description.css', null, DADA_PLUS_VERSION );
	}
