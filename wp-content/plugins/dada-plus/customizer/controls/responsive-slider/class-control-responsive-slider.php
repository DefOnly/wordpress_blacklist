...
class Dada_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'dada-plus-responsive-slider-control', DADA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-responsive-slider-control',  DADA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, DADA_PLUS_VERSION );
	}
