...
class Dada_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dada-plus-fontawesome-control', DADA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-fontawesome-control',  DADA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, DADA_PLUS_VERSION );

		wp_enqueue_style( 'dada-plus-fontawesome',  DADA_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),DADA_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "dada-plus") .' '.esc_html( $this->label );
