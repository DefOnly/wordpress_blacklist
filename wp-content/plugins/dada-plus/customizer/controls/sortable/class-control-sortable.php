...
class Dada_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'dada-plus-sortable-control', DADA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-sortable-control',  DADA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, DADA_PLUS_VERSION );
	}
