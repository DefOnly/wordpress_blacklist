...
class Dada_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'dada-plus-responsive-number-control', DADA_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-responsive-number-control',  DADA_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, DADA_PLUS_VERSION );
	}
