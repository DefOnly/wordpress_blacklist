...
class Dada_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'dada-plus-responsive-spacing-control', DADA_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-responsive-spacing-control',  DADA_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, DADA_PLUS_VERSION );
	}
