...
class Dada_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'dada-plus-radio-image-control', DADA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), DADA_PLUS_VERSION, true );
		wp_enqueue_style( 'dada-plus-radio-image-control',  DADA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, DADA_PLUS_VERSION );
	}
