...
class Dada_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'dada-plus-separator-control',  DADA_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, DADA_PLUS_VERSION );
	}
