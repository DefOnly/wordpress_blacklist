...
if( !class_exists( 'DadaPlusSidebar' ) ) {
    class DadaPlusSidebar {
        ...
        function load_modules() {
            include_once DADA_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('dada_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('dada_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
