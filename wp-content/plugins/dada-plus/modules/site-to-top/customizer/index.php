...
if( !class_exists( 'DadaPlusCustomizerSiteToTop' ) ) {
    class DadaPlusCustomizerSiteToTop {
        ...
        function register_general( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Dada_Customize_Section(
                    ...
                    'site-to-top-section',
                    array(
                        'title'    => esc_html__('To Top', 'dada-plus'),
                ...
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[show_site_to_top]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Dada_Customize_Control_Switch(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[show_site_to_top]', array(
                            'type'    => 'wdt-switch',
                            'section' => 'site-to-top-section',
                            'label'   => esc_html__( 'Enable To Top', 'dada-plus' ),
                            'choices' => array(
...
DadaPlusCustomizerSiteToTop::instance();