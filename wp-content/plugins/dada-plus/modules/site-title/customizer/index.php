...
if( !class_exists( 'DadaPlusCustomizerSiteTitle' ) ) {
    class DadaPlusCustomizerSiteTitle {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Dada_Customize_Section(
                    ...
                    'site-title-section',
                    array(
                        'title'    => esc_html__('Site Title', 'dada-plus'),
            ...
            if ( ! defined( 'DADA_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new Dada_Customize_Control_Separator(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[dada-plus-site-title-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
DadaPlusCustomizerSiteTitle::instance();