...
if( !class_exists( 'DadaPlusH6Settings' ) ) {
    class DadaPlusH6Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dada_h6_selector', array( 'h6' ) );
            $this->settings = dada_customizer_settings('h6_typo');

            add_filter( 'dada_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'dada_h6_typo_customizer_update', array( $this, 'h6_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Dada_Customize_Section(
                    ...
                    'site-h6-section',
                    array(
                        'title'    => esc_html__('H6 Typography', 'dada-plus'),
             ...
             */
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[h6_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Dada_Customize_Control_Typography(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[h6_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h6-section',
                            'label'   => esc_html__( 'H6 Tag', 'dada-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[h6_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[h6_color]', array(
        ...
        function h6_typo_customizer_update( $defaults ) {
            $h6_typo = dada_customizer_settings( 'h6_typo' );
            if( !empty( $h6_typo ) ) {
                return  $h6_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dada_customizer_settings('h6_color');
