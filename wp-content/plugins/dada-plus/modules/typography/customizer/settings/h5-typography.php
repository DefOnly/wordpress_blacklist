...
if( !class_exists( 'DadaPlusH5Settings' ) ) {
    class DadaPlusH5Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dada_h5_selector', array( 'h5' ) );
            $this->settings = dada_customizer_settings('h5_typo');

            add_filter( 'dada_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'dada_h5_typo_customizer_update', array( $this, 'h5_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Dada_Customize_Section(
                    ...
                    'site-h5-section',
                    array(
                        'title'    => esc_html__('H5 Typography', 'dada-plus'),
             ...
             */
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[h5_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Dada_Customize_Control_Typography(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[h5_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h5-section',
                            'label'   => esc_html__( 'H5 Tag', 'dada-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[h5_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DADA_CUSTOMISER_VAL . '[h5_color]', array(
        ...
        function h5_typo_customizer_update( $defaults ) {
            $h5_typo = dada_customizer_settings( 'h5_typo' );
            if( !empty( $h5_typo ) ) {
                return  $h5_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dada_customizer_settings('h5_color');
