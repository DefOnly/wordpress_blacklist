...
if( !class_exists( 'DadaPlusFooterElementor' ) ) {
    class DadaPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'dada_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
            ...
            return apply_filters( 'dada_plus_footer_content', $content );
		}
    }
}

DadaPlusFooterElementor::instance();