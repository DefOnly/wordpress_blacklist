...
if( !class_exists( 'DadaPlusSiteLoaderOne' ) ) {
    class DadaPlusSiteLoaderOne {
        ...
        function add_option( $options ) {
            $options['loader-1'] = esc_html__('Loader 1', 'dada-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', DADA_PLUS_DIR_URL . 'modules/site-loader/layouts/loader-1/assets/css/loader-1.css', false, DADA_PLUS_VERSION, 'all' );
        }
...
DadaPlusSiteLoaderOne::instance();