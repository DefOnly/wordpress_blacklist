...
if( !function_exists('dada_pro_get_template_plugin_part') ) {
    function dada_pro_get_template_plugin_part( $file_path, $module, $template, $slug ) {

        $html             = '';
        $template_path    = DADA_PRO_DIR_PATH . 'modules/' . esc_attr($module);
    ...
    add_filter( 'dada_get_template_plugin_part', 'dada_pro_get_template_plugin_part', 20, 4 );
}

if( !function_exists('dada_pro_before_after_widget') ) {
    function dada_pro_before_after_widget ( $content ) {
        $allowed_html = array(
            'aside' => array(
                'id'    => array(),
                'class' => array()
...
if( !function_exists('dada_pro_widget_title') ) {
    function dada_pro_widget_title( $content ) {
...
if( !function_exists('dada_custom_post_type_elementor_support') ) {
    function dada_custom_post_type_elementor_support() {
...
add_action('init', 'dada_custom_post_type_elementor_support');
