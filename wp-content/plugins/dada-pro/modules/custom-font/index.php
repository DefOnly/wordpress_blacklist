...
if( !class_exists( 'DadaProCustomFont' ) ) {
    class DadaProCustomFont {
        ...
        function load_modules() {
            include_once DADA_PRO_DIR_PATH.'modules/custom-font/taxonomy/index.php';
        }

        function load_customizer(){
            add_filter( 'dada_customizer_custom_fonts', array( $this, 'fonts_list' ), 20 );
        }
        ...
        function elementor_group( $font_groups ) {
            ...
            if( count( $fonts ) > 0 ) {
                $new_group[ 'dada_custom_fonts' ] = esc_html__( 'Custom Font', 'dada-pro' );
        ...
        function load_frontend() {
            add_filter( 'dada_add_inline_style', array( $this, 'custom_font_style' ) );
        }
        ...
        function get_fonts() {
            ...
            $fonts = array();
            $terms = get_terms( 'dada_custom_fonts', array( 'hide_empty' => false ) );
        ...
        function get_font_links( $id ) {
            $meta = get_term_meta( $id, '_dada_custom_font_options', true );
