...
if( !class_exists( 'Dada_Shop_Others_Recently_Viewed_Products' ) ) {

    class Dada_Shop_Others_Recently_Viewed_Products {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('dada_shop_others_recently_viewed_products') ) {
	function dada_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('Dada_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Others_Recently_Viewed_Products::instance();