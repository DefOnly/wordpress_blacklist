...
if( !class_exists( 'Dada_Shop_Others_Size_Guide' ) ) {

    class Dada_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('dada_shop_others_size_guide') ) {
	function dada_shop_others_size_guide() {
        $reflection = new ReflectionClass('Dada_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Others_Size_Guide::instance();