...
if( !class_exists( 'Dada_Shop_Others_Wishlist' ) ) {

    class Dada_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('dada_shop_others_wishlist') ) {
	function dada_shop_others_wishlist() {
        $reflection = new ReflectionClass('Dada_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Others_Wishlist::instance();