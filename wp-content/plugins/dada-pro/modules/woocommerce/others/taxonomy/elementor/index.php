...
class Dada_Shop_Elementor_Taxonomy_Widgets {
	...
	function dada_shop_register_widgets( $widgets_manager ) {
		...
		require dada_shop_others_taxonomy()->module_dir_path() . 'elementor/widgets/product-cat/class-product-cat.php';
		$widgets_manager->register( new Dada_Shop_Widget_Product_Cat() );

		require dada_shop_others_taxonomy()->module_dir_path() . 'elementor/widgets/product-cat-single/class-product-cat-single.php';
		$widgets_manager->register( new Dada_Shop_Widget_Product_Cat_Single() );
	...
	function dada_shop_register_widget_styles( $suffix ) {
		...
		# Product Cat
			wp_register_style( 'wdt-shop-product-cat',
				dada_shop_others_taxonomy()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
				array()
			);
...
Dada_Shop_Elementor_Taxonomy_Widgets::instance();