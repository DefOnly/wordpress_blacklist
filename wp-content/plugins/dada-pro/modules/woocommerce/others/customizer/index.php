...
if( !class_exists( 'Dada_Pro_Customizer_Others' ) ) {

    class Dada_Pro_Customizer_Others {
             ...
             */
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Others', 'dada-pro'),
...
if( !function_exists('dada_customizer_others') ) {
	function dada_customizer_others() {
		return Dada_Pro_Customizer_Others::instance();
	}
}

dada_customizer_others();