...
if( !class_exists( 'Dada_Shop_Others_Cart' ) ) {

    class Dada_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('dada_shop_others_cart') ) {
	function dada_shop_others_cart() {
        $reflection = new ReflectionClass('Dada_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Others_Cart::instance();