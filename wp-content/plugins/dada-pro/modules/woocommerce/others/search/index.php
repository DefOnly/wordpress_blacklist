...
if( !class_exists( 'Dada_Shop_Others_Search' ) ) {

    class Dada_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'dada-pro')
                    )
                );
...
if( !function_exists('dada_shop_others_search') ) {
	function dada_shop_others_search() {
        $reflection = new ReflectionClass('Dada_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Others_Search::instance();