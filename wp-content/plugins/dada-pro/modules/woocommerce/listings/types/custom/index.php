...
if( !class_exists( 'Dada_Woo_Listing_Type_Custom' ) ) {

    class Dada_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'dada-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'dada-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['dada-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['dada-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['dada-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'dada-woo-non-archive', '', array (), DADA_PRO_VERSION, 'all' );
...
if( !function_exists('dada_woo_listing_type_custom') ) {
	function dada_woo_listing_type_custom() {
		return Dada_Woo_Listing_Type_Custom::instance();
	}
}

dada_woo_listing_type_custom();