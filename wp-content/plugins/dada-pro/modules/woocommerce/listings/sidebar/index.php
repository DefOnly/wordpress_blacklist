...
if( !class_exists( 'Dada_Pro_Woo_Sidebar' ) ) {
    class Dada_Pro_Woo_Sidebar {
        ...
        function frontend() {
            add_filter('dada_primary_classes', array( $this, 'primary_classes' ) );
            add_filter('dada_secondary_classes', array( $this, 'secondary_classes' ) );
            add_filter('dada_active_sidebars', array( $this, 'active_sidebars' ), 20 );
            add_filter('dada_woo_loop_column_class', array( $this, 'woo_loop_column_class' ), 10, 2 );
        }

        function primary_classes( $primary_class ) {

            if( is_shop()  ) {
                $settings = get_post_meta( get_option('woocommerce_shop_page_id'), '_dada_layout_settings', true );
