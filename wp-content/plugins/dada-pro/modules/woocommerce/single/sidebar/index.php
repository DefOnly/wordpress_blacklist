...
if( !class_exists( 'Dada_Pro_Woo_single_Sidebar' ) ) {
    class Dada_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('dada_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_dada_layout_settings', true );
...
Dada_Pro_Woo_single_Sidebar::instance();