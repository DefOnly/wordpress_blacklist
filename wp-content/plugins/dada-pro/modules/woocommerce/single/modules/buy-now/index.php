...
if( !class_exists( 'Dada_Shop_Single_Module_Buy_Now' ) ) {

    class Dada_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('dada_shop_single_module_buy_now') ) {
	function dada_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('Dada_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Dada_Shop_Single_Module_Custom_template' ) ) {
    Dada_Shop_Single_Module_Buy_Now::instance();
}