...
if(!function_exists('dada_shop_product_tabs_exploded_html')) {
	function dada_shop_product_tabs_exploded_html($attrs, $content = null) {
		...
		$attrs = shortcode_atts ( array (
			...
			'scroll_height' => '',
			'class'         => ''
		), $attrs, 'dada_shop_product_tabs_exploded' );

		$out = dada_shop_product_tabs_exploded_render_html($attrs);

		return $out;

	}
	add_shortcode( 'dada_shop_product_tabs_exploded', 'dada_shop_product_tabs_exploded_html' );
}


if(!function_exists('dada_shop_product_tabs_exploded_render_html')) {
	function dada_shop_product_tabs_exploded_render_html($settings) {
