...
if( !class_exists( 'Dada_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Dada_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('dada_shop_single_module_count_down_timer') ) {
	function dada_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Dada_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Dada_Shop_Single_Module_Custom_template' ) ) {
    Dada_Shop_Single_Module_Count_Down_Timer::instance();
}