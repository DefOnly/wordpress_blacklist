...
class Dada_Shop_Elementor_Single_Count_Down_Timer_Widgets {
	...
	function dada_shop_load_cdada_modules() {
		...
		require dada_shop_single_module_count_down_timer()->module_dir_path() . 'elementor/utils.php';
	...
	function dada_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'wdt-shop-coundown-timer',
			dada_shop_single_module_count_down_timer()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function dada_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'jquery-downcount',
			dada_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/jquery.downcount'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
		...
		wp_register_script( 'wdt-shop-coundown-timer',
			dada_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
Dada_Shop_Elementor_Single_Count_Down_Timer_Widgets::instance();