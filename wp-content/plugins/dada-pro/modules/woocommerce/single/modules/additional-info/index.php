...
if( !class_exists( 'Dada_Shop_Single_Module_Additional_Info' ) ) {

    class Dada_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('dada_shop_single_module_additional_info') ) {
	function dada_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Dada_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Dada_Shop_Single_Module_Custom_template' ) ) {
    Dada_Shop_Single_Module_Additional_Info::instance();
}