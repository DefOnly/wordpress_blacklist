...
if( !class_exists( 'Dada_Shop_Single_Module_Ajax_Cart' ) ) {

    class Dada_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('dada_shop_single_module_ajax_cart') ) {
	function dada_shop_single_module_ajax_cart() {
		return Dada_Shop_Single_Module_Ajax_Cart::instance();
	}
}

dada_shop_single_module_ajax_cart();