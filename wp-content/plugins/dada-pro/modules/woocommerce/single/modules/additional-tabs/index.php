...
if( !class_exists( 'Dada_Shop_Single_Module_Additional_Tabs' ) ) {

    class Dada_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( dada_is_file_in_theme( __FILE__ ) ) {
                    return DADA_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('dada_shop_single_module_additional_tabs') ) {
	function dada_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Dada_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dada_Shop_Single_Module_Additional_Tabs::instance();