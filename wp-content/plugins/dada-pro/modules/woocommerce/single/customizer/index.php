...
if( !class_exists( 'Dada_Pro_Customizer_Single' ) ) {

    class Dada_Pro_Customizer_Single {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new Dada_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'dada-pro'),
                ...
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'dada-pro'),
                ...
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'dada-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'dada-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'dada-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Dada_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'dada-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('dada_customizer_single') ) {
	function dada_customizer_single() {
		return Dada_Pro_Customizer_Single::instance();
	}
}

dada_customizer_single();