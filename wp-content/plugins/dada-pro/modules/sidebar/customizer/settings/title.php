...
if( !class_exists( 'DadaProWidgetTitleSettings' ) ) {
    class DadaProWidgetTitleSettings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dada_widget_title_selector', array( '.secondary-sidebar .widgettitle' ) );
            $this->settings = dada_customizer_settings('widget_title_typo');
            ...
            add_filter( 'dada_widget_before_title_tag', array( $this, 'before_title' ));
            add_filter( 'dada_widget_after_title_tag', array( $this, 'after_title' ));
        }
        ...
        function register( $wp_customize ){
             ...
             */
                $wp_customize->add_setting(
                    DADA_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    DADA_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        ...
                        'label'   => esc_html__( 'Title Tag', 'dada-pro' ),
                        'choices' => array(
                            'h2'   => 'h2',
                            'h3'   => 'h3',
                            'h4'   => 'h4',
             ...
             */
            $wp_customize->add_setting(
                DADA_CUSTOMISER_VAL . '[widget_title_color]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new Dada_Customize_Control_Color(
                    $wp_customize, DADA_CUSTOMISER_VAL . '[widget_title_color]', array(
                        'section' => 'site-widgets-title-style-section',
             ...
             */
            $wp_customize->add_setting(
                DADA_CUSTOMISER_VAL . '[widget_title_typo]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new Dada_Customize_Control_Typography(
                    $wp_customize, DADA_CUSTOMISER_VAL . '[widget_title_typo]', array(
                        'type'    => 'wdt-typography',
                        'section' => 'site-widgets-title-style-section',
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dada_customizer_settings('widget_title_color');
        ...
        function before_title( $tag ) {
            $t = dada_customizer_settings('widget_title_tag');
            if( !empty( $t ) ){
...
DadaProWidgetTitleSettings::instance();