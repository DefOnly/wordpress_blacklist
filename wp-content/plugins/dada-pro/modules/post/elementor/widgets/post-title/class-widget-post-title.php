...
class Elementor_Post_Title extends DadaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Title', 'dada-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-title-wrapper '.$el_class.'">';
            $out .= dada_get_template_part( 'post', 'templates/post-extra/title', '', $template_args );
		$out .= '</div>';
