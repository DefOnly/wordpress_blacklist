...
class Elementor_Post_Related_Article extends DadaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Related Article', 'dada-pro');
    }
    ...
    protected function render() {
        ...
        $out .= dada_get_template_part( 'post', 'templates/post-extra/related_article', '', $template_args );
