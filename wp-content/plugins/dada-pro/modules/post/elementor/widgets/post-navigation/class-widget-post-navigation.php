...
class Elementor_Post_Navigation extends DadaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Navigation', 'dada-pro');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'navi_class', array(
                ...
                'label'       => esc_html__('Select Navigation type', 'dada-pro'),
                'default' => 'type1',
                'options' => array(
    ...
    protected function render() {
		...
		$out .= '<div class="entry-post-navigation-wrapper '.$el_class.'">';
            $out .= dada_get_template_part( 'post', 'templates/post-extra/navigation', '', $template_args );
		$out .= '</div>';
		echo $out;
	}
